...
// Mock the streak utils
jest.mock('@/lib/streakUtils', () => ({
  updateStreakOnCompletion: jest.fn(() => 6),
}))
...
describe('HabitItem', () => {
  ...
  it('calls updateHabit when toggle button is clicked', async () => {
    ...
    const mockUpdateStreakOnCompletion = updateStreakOnCompletion as jest.MockedFunction<typeof updateStreakOnCompletion>
